...
def main(list_of_structures, targit_stoic, replica):
	...
	output('Havent defined crossover for this number of molecules')	
...
#	print "child geo", child_geo
	...
	#take lattice of random combo of parent A + B
		rand_vec = [random.random.uniform(0.25,0.75) for i in range(3)]
...
#	print "child geo", child_geo
	...
	cross_types = [[1,1],[1,2],[1,3],[2,1],[2,2],[2,3],[3,1],[3,2],[3,3],[4,1],[4,2],[4,3],[5,1],[5,2],[5,3],[6,1],[6,2],[6,3],[7,1],[7,2],[7,3],[8,1],[8,2],[8,3]]
	method = random.choice(cross_types)
	return method
