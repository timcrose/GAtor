...
#        element_list.sort()
	...
	ambertypes = ['C', 'CT','H1', 'H1', 'N3', 'H', 'H','H', 'O2', 'O2','C', 'CT','H1', 'H1', 'N3', 'H', 'H','H', 'O2', 'O2','C', 'CT','H1', 'H1', 'N3', 'H', 'H','H', 'O2', 'O2','C', 'CT','H1', 'H1', 'N3', 'H', 'H','H', 'O2', 'O2']
	ambernum = [503, 351, 355, 355, 350, 353, 353, 353, 505, 505, 503, 351, 355, 355, 350, 353, 353, 353, 505, 505, 503, 351, 355, 355, 350, 353, 353, 353, 505, 505, 503, 351, 355, 355, 350, 353, 353, 353, 505, 505 ]
	...
	connect2[4+repeat] = connect2[4]+repeat 
        ...
        connect2[0+2*repeat] = connect2[0]+2*repeat
        connect3[0+2*repeat] = connect3[0]+2*repeat

        connect2[1+2*repeat] = connect2[1]+2*repeat
        connect3[1+2*repeat] = connect3[1]+2*repeat
        connect4[1+2*repeat] = connect4[1]+2*repeat

        connect2[4+2*repeat] = connect2[4]+2*repeat
        connect3[4+2*repeat] = connect3[4]+2*repeat
        connect4[4+2*repeat] = connect4[4]+2*repeat

        connect2[0+3*repeat] = connect2[0]+3*repeat
        connect3[0+3*repeat] = connect3[0]+3*repeat

        connect2[1+3*repeat] = connect2[1]+3*repeat
        connect3[1+3*repeat] = connect3[1]+3*repeat
        connect4[1+3*repeat] = connect4[1]+3*repeat

        connect2[4+3*repeat] = connect2[4]+3*repeat
        connect3[4+3*repeat] = connect3[4]+3*repeat
        connect4[4+3*repeat] = connect4[4]+3*repeat
	...
	element_lst = ['C','C','H','H','N','H','H','H','O','O','C','C','H','H','N','H','H','H','O','O','C','C','H','H','N','H','H','H','O','O','C','C','H','H','N','H','H','H','O','O']	
