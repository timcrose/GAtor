...
#		pm =  ui.get("parallel_settings","parallelization_method")
#		if pm == "mira" or pm == "cetus":
...
#			raise ValueError("Missing execute command for FHI-aims")
	...
	if execute_command == "mpirun":
		...
		if ui.has_option("parallel_settings","processes_per_node"):
			arglist += ["-n",ui.get("parallel_settings","processes_per_node")]	
